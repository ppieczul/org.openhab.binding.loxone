...
|----|----|----|----|----|----|
|InfoOnlyAnalog|Analog [virtual inputs](https://www.loxone.com/enen/kb/virtual-inputs-outputs/) (virtual state) |`String`<br>`Number`|none (read-only value)|`loxone:miniserver:<serial>:infoonly`<br> `loxone:miniserver:<serial>:valueonly`|`loxone:miniserver:<serial><uuid>`<br>`loxone:miniserver:<serial><uuid>-1`|
|InfoOnlyDigital|Digital [virtual inputs](https://www.loxone.com/enen/kb/virtual-inputs-outputs/) (virtual state) |`String`<br>`Number`|none (read-only value)|`loxone:miniserver:<serial>:infoonly`<br>`loxone:miniserver:<serial>:valueonly`| `loxone:miniserver:<serial>:<uuid>`<br>`loxone:miniserver:<serial>:<uuid>-1`
...
|TextState|[State](https://www.loxone.com/enen/kb/state/)|`String`<br>`Number`|none (read-only value)|`loxone:miniserver:<serial>:infoonly`<br>`loxone:miniserver:<serial>:valueonly`|`loxone:miniserver:<serial>:<uuid>`<br>`loxone:miniserver:<serial>:<uuid>-1`
...
Channel ID is defined in the following way: 
  ...
  * For other control's channels: `loxone:miniserver:<serial>:<control-UUID>-<channel-index>`, where `channel-index >=1`
